...
/** \mainpage CompText Sourcecode Interactive Doxygen Documentation : 000GIT_REVISION000
 <div align="center"><img src="fldigi-psk.png" ></div>

 \section intro Introduction

  Welcome to the CompText Interactive Doxygen Sourcecode Documentation!
  Here you'll find information useful for developing and debugging CompText. 
  
CompText is used to compare two text streams.<BR>
It's comparison function uses a linear-programming technique.<BR>
It computes total number of errors, the character error rate (CER) and the bit error rate (BER).<BR><BR>


  <BR>
  \section download To Download CompText :
  <UL>
  ...
  <OL>
  <LI>Download the CompText sourcecode as described above</LI>
  ...
  \section license License
 	...
 	CompText is free software; you can redistribute it and/or modify
 	it under the terms of the GNU General Public License as published by
 	the Free Software Foundation; either version 3 of the License, or
 	(at your option) any later version.
