...
int main(int argc, char **argv) 
{
	...
	main_window = make_comptext_win();

	Fl::visual (FL_DOUBLE|FL_INDEX);

	sprintf (title, "comptext %s", comptext_VERSION);
	...
	make_pixmap(&comptext_icon_pixmap, comptext_icon);
	main_window->icon((char *)comptext_icon_pixmap);
	main_window->show(argc, argv);
#else
	main_window->show(argc, argv);
#endif
